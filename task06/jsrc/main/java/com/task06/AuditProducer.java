...
public class AuditProducer implements RequestHandler<DynamodbEvent, Void> {
	...
	@Override
	public Void handleRequest(DynamodbEvent dynamodbEv, Context context) {
		for (DynamodbEvent.DynamodbStreamRecord record : dynamodbEv.getRecords()) {
	...
	private void processInsert(DynamodbEvent.DynamodbStreamRecord record) {
		...
		newMap.put("key", newItem.get("key"));
		newMap.put("value", newItem.get("value"));
		auditEntry.put("newValue", AttributeValue.builder().m(newMap).build());
